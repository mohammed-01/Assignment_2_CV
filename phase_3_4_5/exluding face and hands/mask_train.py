...
# Paths
train_list_path = "D:/LV-MHP-v2/LV-MHP-V2-Subset/list/train.txt"  # List of 150 selected images
parsing_anno_path = "D:/LV-MHP-v2/val/parsing_annos"  # Parsing annotations folder
dest_mask_path = "D:/LV-MHP-v2/LV-MHP-V2-Subset/train/masks"  # Output mask folder
